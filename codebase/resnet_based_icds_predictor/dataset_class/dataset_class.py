...
meta_version = 'v5' # v4 is 1-1 metric calculation, v5 is 1-many

config = {
#     'scores_filename': 'total_scores_v4_cider(df_control).json',
    'scores_filename': 'total_scores_v5.json',
    'img_path': '/home/mkorchevskiy/datasets/coco/train2014'
}

class ImageDataset(Dataset):

    def __init__(self, mode='train', split=(0.7, 0.1), transform=None, targets=None):
        self.meta_path = os.path.expanduser('/home/mkorchevskiy/datasets/meta/{}/'.format(meta_version))
